...
class ChannelConfiguration:
    ...
    def __init__(self, connection, logger, io_loop=None,
                 exchange=None, exchange_type=None, queue=None, routing_key=None, durable=None, auto_delete=None):
        self.logger = logger
    ...
    def _create_channel(self):
        ...
        self._connection.channel(on_open_callback=open_callback)
